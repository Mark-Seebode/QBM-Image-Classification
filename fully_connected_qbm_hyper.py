...
def run_slurm_with_hyperparams(learning_rate, n_hidden_nodes, batch_size, sample_count,  seed): #restricted, anneal):
    """Submits a SLURM job with hyperparameters and waits for it to complete."""

    shell_script = "fully_connceted_single_seed.sh"
    slurm_command = [
        "sbatch", shell_script,
        str(learning_rate),
        str(n_hidden_nodes),
...
if __name__ == '__main__':
    ...
    parser.add_argument('-nh', '--n_hidden_nodes',
                        metavar='INT',
    ...
    parser.add_argument('--sweep_id', type=str, default="co7s008k") #v8vwy5dq breast mnistk3i5g39d current rbm penumonia estex4pi   current sq qbm xzvm3exu
